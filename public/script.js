  ...
  const runAnimation = async () => {
    ...
    containerPopup.innerHTML = `
      <div class="analyzing" style="font-family: 'Hack', monospace;">
        <h2>Terminal</h2>
        <p id="step1" class="blur-in">$ Mendeteksi Foto Anda.....</p>
    ...
    await animateText(step1, '$ Mendeteksi Foto Anda.....', 1000);
    displayText(step1, '$ Foto Berhasil Terdeteksi....');
    ...
    .then(data => {
      ...
      step2.textContent = '$ Upload Foto Berhasil';

      step3.classList.add('blur-in');
      step3.textContent = '$ Ramal Khodam Anda.....';
      return animateText(step3, '$ Ramal Khodam Anda.....', 1000);
    })
    .then(() => {
      displayText(step3, '$ Khodam Anda Terdeteksi');
      return fetch('/submit', {
        method: 'POST',
        body: formData
      });
      ...
      setTimeout(() => {
        ...
        containerPopup.innerHTML = `
          <div class="result" style="font-family: 'Poppins', sans-serif">
            ...
            <h2>Hai ${data.name}</h2>
            <p><strong>Khodam</strong> kamu adalah <strong>${data.khodam}</strong></p>
            ...
            <p style="color: #333333ad;">Share hasil cek <strong>khodam</strong> kamu di sosmed</p>
          </div>
        `;
    ...
    .catch(error => {
      step4.classList.add('blur-in');
      step4.textContent = '$ Upps Ada yang salah....';
    });
  };
...
document.getElementById('photo').addEventListener('change', function(event) {
  const fileName = event.target.files[0] ? event.target.files[0].name : "Upload foto kamu";
